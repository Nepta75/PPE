...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
     ...
     */
    $vendorFolders = array(dirname(dirname(__FILE__)) . '/includes/topdf/html2pdf-master/src');
    $k_path_main=dirname(dirname(__FILE__)) .  '/includes/topdf/html2pdf-master/src';
