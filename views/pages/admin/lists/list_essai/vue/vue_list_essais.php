            ...
            <tr>
                ...
                <td class="column9">
                    <div style="display: flex">
                        <a class="ml-3" href="admin?page=7&statut=confirme&id=<?= $data['id_essayer']?>"><i style="color: green;" class="fas fa-check"></i></a>
                        <a class="ml-3" href="admin?page=7&statut=refuser&id=<?= $data['id_essayer']?>"><i style="color: red;" class="fas fa-ban"></i></a>
                        <a class="ml-3" href="admin?page=7&delete=<?= $data['id_essayer'] ?>"><i style="color: red;" class="fas fa-trash-alt"></i></a>
                    </div>
                </td>
            </tr>
    <?php } ?>
