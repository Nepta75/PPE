<div class="fiche">
    ...
    <div class="fiche__vehicule">
        ...
        <div class='fiche__container fiche__container--vehicule'>
            ...
            <div class='fiche__element'>
                ...
                <div><label>Km :</label><?= $data['km'] ?>km</div>
                <div><label>Prix :</label><?= $data['prix'] ?></div>
            </div>
            <h4>Détails</h4>
            <div class='fiche__element'>
                <div><label>Etat :</label><?= $data['etat'] ?></div>
                <div><label>Info :</label><?= $data['information'] ?></div>
    ...
    <div class="reserver m-3"><a href="essayer?immat=<?= $data['immatriculation']?>">Essayer</a></div>
</div>